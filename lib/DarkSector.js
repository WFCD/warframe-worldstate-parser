...
class DarkSector extends WorldstateObject {
  ...
  constructor(data, { mdConfig, translator, Mission, DarkSectorBattle, Reward }) {
    ...
    this.defenderDeployemntActivation =
      new Date(data.DefenderInfo.DeploymentActivationTime.$date ? data.DefenderInfo.DeploymentActivationTime.$date.$numberLong : 1000 * data.DefenderInfo.DeploymentActivationTime.sec);
