...
export class WorldState {
  ...
  constructor(json, deps = defaultDeps) {
    ...
    return Promise.resolve(
      (async () => {
        this.events = await parseAsyncArray(WorldEvent, data.Goals, deps);
        this.syndicateMissions = await parseAsyncArray(SyndicateMission, data.SyndicateMissions, deps, 'syndicate');
...
export default async (json, deps) => new WorldState(json, deps);
