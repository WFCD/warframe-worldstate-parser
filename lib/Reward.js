...
const rewardTypes = [
  {
    ...
    thumbnail: 'https://cdn.warframestat.us/img/vauban.png',
    color: 0x5C5A53,
  },
  {
    name: 'vandal',
  ...
  {
    name: 'cetusWisp',
    description: 'Cetus Wisp',
    test: s => /cetus\swisp/i.test(s),
    thumbnail: 'https://cdn.warframestat.us/img/cetus-wisp.png',
    color: 0xC8F8FF,
  },
  {
    name: 'circuits',
