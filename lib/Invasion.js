...
class Invasion extends WorldstateObject {
  ...
  constructor(data, {
    ...
    */
     ...
     * @type {string}
     */
    this.attackingFaction = translator.faction(data.AttackerMissionInfo.faction, locale);
     ...
     * @type {string}
     */
    this.defendingFaction = translator.faction(data.DefenderMissionInfo.faction, locale);
